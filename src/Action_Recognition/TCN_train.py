...
from src.Action_Recognition.models.arguments_TCN import get_args
...
from src.Action_Recognition.models.models_TCN import Step_Model_TCN_classification_lstm, Step_Model_TCN
import numpy as np
...
if __name__ == "__main__":
    ...
    num_channels = [args.hidden_dim] * args.level
    ...
    if args.memory_predictor:
        step_model = Step_Model_TCN_classification_lstm(args.input_dim, args.output_dim, num_channels, args.kernel_size, args.dropout,
                                                        args.num_action, args.num_ingredient, device).to(device)
    else:
        step_model = Step_Model_TCN(args.input_dim, args.output_dim, num_channels, args.kernel_size, args.dropout, args.num_action,
                                    args.num_ingredient, device).to(device)
    if args.eval:
