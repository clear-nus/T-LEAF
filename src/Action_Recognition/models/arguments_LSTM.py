...
def get_args():
    ...
    parser.add_argument("--model_save_path", type=str, default="./saved_models/Action_Recognition/videos/LSTM/")
    ...
    parser.add_argument("--clip", type=float, default=10.0, help= " the threshold to judge the output is 1 or 0")
    ...
    parser.add_argument("--lamda", default=5, type=int, help="tradeoff factor")
